...
# Corregimos el error en la ruta, elegimos la ruta por defecto dentro del proyecto
vpth = "./"

# se configuran variables que almacenan el diseño de distintos emojis en CSS
...
def ScoreEmoji():
    # Esta función agrega un emoji dependiendo el score que logré el usuario
...
def Main():
    ...
    with st.sidebar:
        ...
        mystate.GameDetails[3] = st.text_input("Player Name, Country", placeholder='Usuario, Colombia', help='Optional input only for Leaderboard')
